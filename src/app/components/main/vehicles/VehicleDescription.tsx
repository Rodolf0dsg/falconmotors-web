...
export const VehicleDescription = () => {
  return (
    <div
      className="mt-8 bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark p-6">
      <h3 className="text-lg font-bold text-surface-light">Descripción General</h3>
      <hr className="border-t border-border-light dark:border-border-dark my-4" />
      <div className="flex items-center gap-4 mb-4">
        <div className="w-14 h-14 flex items-center justify-center rounded-lg bg-white shadow-sm flex-shrink-0">
        ...
        <div>
          <p className="font-semibold text-text-light dark:text-text-dark">Vendido por</p>
